...
## In Progress
- [x] #4 Add Task REST API endpoints to `server.ts` — role:coder, claimed-by:4eb358a5
- [x] #7 Integrate tasks into system prompt assembly (`system-prompt.ts`) — role:coder, claimed-by:36216a90
