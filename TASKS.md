...
## Done
- [x] #2 Implement TaskManager (`src/server/agent/task-manager.ts`) — role:coder, completed-by:coder-26bb6705
...
- [x] #5 Add Cost REST API endpoints to `server.ts` — role:coder, completed-by:coder-b6678f91
