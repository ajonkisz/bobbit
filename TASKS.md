...
- [x] #13 Fix critical/major review findings — role:coder, completed-by:7bb51a3f
- [x] #14 Fix minor review findings — role:coder, completed-by:f91180c7

## Findings (all addressed)
- #10.C1 [critical] updateTask() bypasses sub-task completion validation — FIXED in #13
- #10.M4 [major] No TaskType/TaskState input validation — FIXED in #13
- #10.M5 [major] No goalId existence validation on task creation — FIXED in #13
- #10.m1 [minor] N disk writes on batch delete — FIXED in #14 (removeMany)
- #10.m2 [minor] cost_update missing goalId/taskId — FIXED in #13
- #10.m3 [minor] Unused goalId param in getGoalCost — FIXED in #13 (_goalId)
- #10.m4 [minor] Goal cost only counts in-memory sessions — FIXED in #14 (getAllSessionIdsForGoal)
- #10.m5 [minor] dependsOn not validated for duplicates/self-refs — FIXED in #14
- #10.m7 [minor] No data shape validation on load — FIXED in #14
- #10.S4 [suggestion] Floating-point cost accumulation — FIXED in #14 (Math.round)
