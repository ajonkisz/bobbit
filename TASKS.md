...
## In Progress
- [x] #1 Pass env vars (BOBBIT_GATEWAY_URL, BOBBIT_AUTH_TOKEN, BOBBIT_GOAL_ID, BOBBIT_SESSION_ID) to worker sessions in spawnRole() — role:coder, claimed-by:coder-09fee49e
