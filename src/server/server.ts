...
export function createGateway(config: GatewayConfig) {
	...
	const requestHandler = async (req: http.IncomingMessage, res: http.ServerResponse) => {
		...
		if (url.pathname.startsWith("/api/")) {
			...
			await handleApiRoute(url, req, res, sessionManager, config, colorStore, teamManager, roleManager, toolManager, goalArtifactStore, artifactSpecManager, traitManager, bgProcessManager, staffManager);
