...
export const storage = new AppStorage(settings, providerKeys, sessions, customProviders, goalDrafts, roleDrafts, specDrafts, personalityDrafts, commandHistory, backend);
