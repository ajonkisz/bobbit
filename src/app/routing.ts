...
export type RouteView = "landing" | "session" | "goal" | "goal-dashboard" | "roles" | "role-edit" | "tools" | "tool-edit" | "artifact-specs" | "artifact-spec-edit" | "staff" | "staff-edit";

export function getRouteFromHash(): { view: RouteView; sessionId?: string; goalId?: string; roleName?: string; toolName?: string; artifactSpecId?: string; staffId?: string } {
