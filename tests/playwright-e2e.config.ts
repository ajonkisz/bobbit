...
export default defineConfig({
	testDir: ".",
	testMatch: ["session-rename.spec.ts", "image-attachment.spec.ts", "compaction.spec.ts", "goals.spec.ts", "workflow-status.spec.ts", "delegate-ui.spec.ts", "swarm-lifecycle.spec.ts"],
	timeout: 180_000,
